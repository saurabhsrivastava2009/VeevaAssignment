...
public class MensShoppingPage extends NBAWarriorsHomePage {
     ...
     *
     * @param element - the element for which you want the title
     ...
     *
     * @param element - the element for which you want the price
     ...
     *
     * @param element - the element for which you want the seller message
